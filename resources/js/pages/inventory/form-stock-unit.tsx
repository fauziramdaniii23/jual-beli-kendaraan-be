                        ...
                        <div className="flex-1">
                            <FieldGroup>
                                ...
                                <Field>
                                    ...
                                    <DatePicker
                                        value={
                                            form.data.stnk_validity_period || ''
                                        }
                                        onChange={(val) =>
                                            form.setData(
                                ...
                                <Field>
                                    ...
                                    <MultiSelect
                                        ...
                                        onChange={(selected) =>
                                            form.setData('promo_ids', selected)
                                        }
                                        placeholder="Pilih promo"
                                        disabled={disable}
                                    />
                                    {form.errors.promo_ids && (
                                        <div className="text-sm text-destructive">
                                            {form.errors.promo_ids}
                                        </div>
                                    )}
